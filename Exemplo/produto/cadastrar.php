...
<body>
<form action="listar.php" id="cadastrarProduto" method="POST">
  <div class="container">
      <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="email" class="form-control" id="001" name="email" aria-describedby="email" placeholder="Digite seu E-mail">
            <small nome="emailHelp" class="form-text text-muted"></small>
          </div>
          <div class="form-group">
